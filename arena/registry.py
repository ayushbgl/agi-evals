...
# Each entry maps game_type to component paths
GAME_REGISTRY: Dict[str, Dict[str, str]] = {
    "catan": {
        "game_module": "games.catan",
        "environment_class": "catan_arena.envs.catan_pettingzoo.CatanAECEnv",
...
def get_game_class(game_type: str) -> Type[Game]:
    ...
    registry_entry = GAME_REGISTRY[game_type]

    # Some games use "game_class", others use "environment_class"
    class_path = registry_entry.get("game_class") or registry_entry.get("environment_class")
